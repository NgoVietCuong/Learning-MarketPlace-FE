        ...
        <div className="px-10 py-8 flex flex-col gap-4">
          <div className="flex justify-between">
            ...
            <div className="flex items-center gap-2">
              <Button size="sm" variant={'outline'} className="p-[15px]">Publish</Button>
              <Button size="sm" variant={'destructive'} className="p-2"><Trash2 className='w-[17px] h-[17px]' /></Button>
            </div>
          </div>
              ...
              <div className="flex gap-7">
                <div className="w-[35%] flex flex-col gap-3">
                  <div className="w-full flex flex-col items-start gap-1">
                    ...
                    <Input type="text" placeholder="Enter course title" className="mb-[5px] pr-[100px]" />
                  </div>
                  <div className="w-full flex flex-col items-start gap-1">
                    <Text size="sm" className="font-medium !text-gray-600">
                      Overview
                    </Text>
                    <Input type="text" placeholder="Enter course overview" className="mb-[5px] pr-[100px]" />
                  </div>
                  <div className="w-full flex flex-col items-start gap-1">
                    <Text size="sm" className="font-medium !text-gray-600">
                      Description
