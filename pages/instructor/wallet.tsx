...
export default function InstructorSettings() {
  ...
  const handleOnboardMerchant = async () => {
    setOnboarding(true);
    const onboardResponse = await paymentApi.onboardMerchant();
    console.log("onboardResponse", onboardResponse)
        ...
        <div className="px-10 py-8 flex flex-col gap-8">
          ...
          <div className="w-full flex flex-col gap-4">
            <div className="w-[40%] space-y-4">
              ...
              <Button disabled={onboarding} size="sm" className="active:scale-[98%] px-4" onClick={handleOnboardMerchant}>
